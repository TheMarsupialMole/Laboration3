...
String::iterator String::begin() {
	return String::iterator(strPtr);
}

String::iterator String::end() {
	return String::iterator(strPtr + siz);
}

String::reverse_iterator String::rbegin() {
	return String::reverse_iterator(strPtr + siz - 1);
}

String::reverse_iterator String::rend() {
	return String::reverse_iterator(strPtr - 1);
}


//void main() {
//
//	String str("tertertert");
//	iterator itr(str.begin(), str.end());
//	iterator itr2 = itr;
//	while (itr2.hasNext()) {
...
//	std::cout << std::endl;
//	String str2("qwerty");
//	rIterator ritr(str2.begin(), str2.end());
//	rIterator ritr2 = ritr;
//	ritr2 + 2;
//	while (ritr2.hasNext()) {
//		std::cout << *ritr2 << std::endl;
//		++ritr2;
//	}
//	std::cin.get();
//}